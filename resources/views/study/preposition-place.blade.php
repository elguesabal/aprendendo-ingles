                ...
                <div class="flex flex-col w-3/4 mx-auto">
                    <section class="my-5">
                        ...
                        <ul class="list-disc pl-6">
                            <li>The keys are in my bag.</li>
                            <li>He lives in Brazil.</li>
                        </ul>
                    </section>
                </div>
            </div>
            <div class="theme-secondary py-10">
                <div class="flex flex-col w-3/4 mx-auto">
                    <section class="my-5">
                        ...
                        <h2 class="text-lg font-bold mb-2">Exemplos:</h2>
                        <ul class="list-disc pl-6">
                            <li>The phone is on the table.</li>
                            <li>There’s a picture on the wall.</li>
                        </ul>
                    </section>
                </div>
            </div>
            <div class="theme-primary py-10">
                <div class="flex flex-col w-3/4 mx-auto">
                    <section class="my-5">
                        ...
                        <h2 class="text-lg font-bold mb-2">Exemplos:</h2>
                        <ul class="list-disc pl-6">
                            <li>The dog is behind the sofa.</li>
                            <li>The pen is behind the coup.</li>
                        </ul>
                    </section>
                </div>
            </div>
            <div class="theme-secondary py-10">
                <div class="flex flex-col w-3/4 mx-auto">
                    <section class="my-5">
                        ...
                        <h2 class="text-lg font-bold mb-2">Exemplos:</h2>
                        <ul class="list-disc pl-6">
                            <li>The car is in front of the house.</li>
                            <li>The cat is in front of the box.</li>
                        </ul>
                    </section>
                </div>
            </div>
            ...
            <div class="theme-secondary py-10">
                <div class="flex flex-col w-3/4 mx-auto">
                    <section class="my-5">
                        ...
                        <h2 class="text-lg font-bold mb-2">Exemplos:</h2>
                        <ul class="list-disc pl-6">
                            <li>The shoes are under the bed.</li>
                            <li>The chair are under the table.</li>
                        </ul>
                    </section>
                </div>
            </div>
            <div class="theme-primary py-10">
                <div class="flex flex-col w-3/4 mx-auto">
                    <section class="my-5">
                        ...
                        <h2 class="text-lg font-bold mb-2">Exemplos:</h2>
                        <ul class="list-disc pl-6">
                            <li>The door next to the window.</li>
