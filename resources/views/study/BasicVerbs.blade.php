...
<!-- https://www.happyhues.co/palettes/9 -->
    ...
    <!-- <main class="bg-primary text-secondary">
        <h1 class="text-3xl font-bold mb-10 text-primary text-center">Verbs</h1>

        <div class="flex flex-col w-3/4 mx-auto mb-10">
            <section>
                <h2 class="text-3xl font-bold mb-2 text-primary">📌 O que é um verbo?</h2>
                <p>Verbo é uma ação ou estado.</p>
                <p>Exemplos em português: ser, estar, ter, gostar, falar, comer...</p>
            </section>
        </div>
        <div class="flex flex-col w-3/4 mx-auto mb-10">
            <section>
                <h2 class="text-2xl text-primary">To be (ser/estar)</h2>
                <table class="mx-auto table-fixed w-3/4 border-collapse border text-center">
        ...
        <div class="flex flex-col w-3/4 mx-auto mb-10">
            <section>
                <h2 class="text-2xl text-primary">To have (ter)</h2>
                <table class="mx-auto table-fixed w-3/4 border-collapse border text-center">
                    <thead class="bg-secondary">
                        <tr>
                            <th class="w-1/2 border border-gray-300 px-4 py-2">Pronoun</th>
        ...
        <div class="flex flex-col w-3/4 mx-auto mb-10">
            <section>
                <h2 class="text-2xl text-primary">To like (gostar)</h2>
                <table class="mx-auto table-fixed w-3/4 border-collapse border text-center">
                    <thead class="bg-secondary">
                        <tr>
                            <th class="w-1/2 border border-gray-300 px-4 py-2">Pronoun</th>
